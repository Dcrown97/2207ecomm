                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-thumbnail text-start">
                                            <img src="../../zakas/assets/img/products/prod-10-70x88.jpg" alt="Product Thumnail">
                                        </td>
                                        ...
                                        <td class="product-action-btn">
                                            <a href="cart.html"
                                                class="btn btn-small btn-bg-red btn-color-white btn-hover-2">Add to cart</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="product-remove text-start"><a href="#"><i
                                                    class="flaticon flaticon-cross"></i></a></td>
                                        <td class="product-thumbnail text-start">
                                            <img src="../../zakas/assets/img/products/prod-11-70x88.jpg" alt="Product Thumnail">
                                        </td>
                                        <td class="product-name text-start wide-column">
                                            <h3>
                                    ...
                                    <tr>
                                        <td class="product-remove text-start"><a href="#"><i
                                                    class="flaticon flaticon-cross"></i></a></td>
                                        <td class="product-thumbnail text-start">
                                            <img src="../../zakas/assets/img/products/prod-12-70x88.jpg" alt="Product Thumnail">
                                        </td>
                                        <td class="product-name text-start wide-column">
                                            <h3>
                                    ...
                                    <tr>
                                        <td class="product-remove text-start"><a href="#"><i
                                                    class="flaticon flaticon-cross"></i></a></td>
                                        <td class="product-thumbnail text-start">
                                            <img src="../../zakas/assets/img/products/prod-13-70x88.jpg" alt="Product Thumnail">
                                        </td>
                                        <td class="product-name text-start wide-column">
                                            <h3>
