...
<body>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light main_box">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="/"><img src="{{ asset('/img/tbally-logo.png') }}"
                            alt=""></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item @yield('shop')"><a class="nav-link"
                                    href="{{ route('shop') }}">Shop</a></li>
                            <li class="nav-item @yield('story')"><a class="nav-link" href="{{ route('story') }}">Our
                                    Story</a></li>
                            <li class="nav-item @yield('login')"><a href="{{ route('login') }}" class="nav-link">Sign
                                    In</a></li>
        ...
        <div class="container">
                ...
                <div class="col-lg-4  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <p>
                            ...
                            2207bytbally is known for its signature bold approach to colours, form-fitting tailored
                            pieces, simple and yet classy fashion.

                            The designs are youthful, colourful and versatile, making the outfits wearable for women
            ...
            <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
                <p class="footer-text m-0">
                    ...
                    </script> All rights reserved | This site was created by<a href="https://ftsl-ng.com"
                        target="_blank"> Flyte Technologies and Solutions LTD</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
    ...
    <a href="/" class="btn btn-xs currency" data-toggle="modal" data-target="#setCur">
            ...
            <div class="modal-content">
                <ul class="currency-list">
                    ...
                    <li @if (session('currency') == 'Naira') class="active" @endif><a
                            href="{{ route('currency', 'ngn') }}">Nigerian Niara (NGN)</a></li>
                    <li @if (session('currency') != 'Naira') class="active" @endif><a
                            href="{{ route('currency', 'dol') }}">US DOLLARS (USD)</a></li>
                </ul>
            </div>
            <!-- /.modal-content -->
        </div>
