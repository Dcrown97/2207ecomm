        ...
        <div class="container">
            @if (Auth::user() == null)
                <div class="returning_customer mb-4">
                    <div class="check_title">
                        <h2>Returning Customer? <a data-toggle="collapse" href="#signin" role="button"
                                aria-expanded="false" aria-controls="signin">Click here to login</a></h2>
                    </div>
            ...
            @if (null == $products['coupon'] && empty($products['coupon']))
                <div class="cupon_area" id="coupon_area">
                    <div class="check_title">
                        <h2>Have a coupon? <a data-toggle="collapse" href="#coupon" role="button" aria-expanded="false"
                                aria-controls="coupon">Click here to enter your code</a></h2>
                    </div>
            ...
            <div class="billing_details">
                <form class="contact_form" id="payment" action="#" method="post">
                    <input type="hidden" name="coupon" id="cou"
                        value="@if (null != $products['coupon'] && !empty($products['coupon'])) {{ $products['coupon'] }} @endif">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <input type="text" class="form-control" id="add2" name="street2"
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="creat_account">
                                        ...
                                        <input type="checkbox" id="f-option3" data-toggle="collapse" href="#address2"
                                            role="button" aria-expanded="false" aria-controls="address2">
                                ...
                                <div class="row collapse" id="address2">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <input type="text" class="form-control" id="company_ship" name="company_ship"
                                            placeholder="Company name">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <input type="text" class="form-control" id="number_ship" name="phone_ship"
                                            placeholder="Phone number">
                                    </div>
                                    <div class="col-md-6 form-group p_star">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <select class="form-control" name="country_ship" id="country"
                                            style="width: 100% !important;">
                                            <option value="">Select Country</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group p_star">
                                        <select class="form-control w-100" name="state_ship" id="state"
                                            style="width: 100% !important;">
                                            <option value="">Select State</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input type="text" class="form-control" id="zip_ship" name="postal_ship"
                                            placeholder="Postcode/ZIP">
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                            ...
                            <div class="order_box">
                                ...
                                <ul class="list">
                                    ...
                                    foreach($products['items'] as $item):
                                        ...
                                        ?>
                                    <li><a href="#">{{ $item['item']['name'] }}<span class="middle">x
                                                {{ $item['item']['qty'] }}</span> <span
                                                class="last">{{ $cur . number_format($item['item']['cost'], 2) }}</span></a>
                                    </li>
                                    <?php
                                    endforeach;
                                ...
                                <ul class="list list_2">
                                    ...
                                    <li><a href="#">Shipping
                                            <span>{{ $cur . number_format($products['shipping'], 2) }}</span></a></li>
                                    @if (null != $products['coupon'] && !empty($products['coupon']))
                                        <li><a href="#">Coupon
                                                <span>-{{ $cur . number_format($products['coupon_amt'], 2) }}</span></a></li>
            ...
            $.ajax({
                ...
                complete: function(response) {
                    if (response.status === 200) {
                        ...
                        var new_tot = Number(total_val.replace(/[^0-9.-]+/g, "")) - Number(amt.replace(
                            /[^0-9.-]+/g, ""));
                        $('#total_val').text('{{ $cur }}' + new_tot.toFixed(2).replace(
                            /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,'));
        ...
        $('#payment').on('submit', function(e) {
            ...
            var total =
                @if (null != $products['coupon'] && !empty($products['coupon']))
                    {{ $total * 100 }}
                @else
                    Number($("#total_val").text().replace(/[^0-9.-]+/g, "")) * 100
                @endif ;
