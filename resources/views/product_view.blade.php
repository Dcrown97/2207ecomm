        ...
        <div class="container">
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="row s_product_inner">
                        <div class="col-12">
                            <img src="@if ($product->images->isNotEmpty()) {{ asset('/img/products/' . $product->images[0]->file_path) }} @endif"
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            <li><a class="active" href="/shop?cat={{ $product->category->name }}"><span>Category</span> :
                                    {{ $product->category->name }}</a></li>
                            <li><a href="#"><span>Availibility</span> : @if ($product->sizes->where('quantity', '>', '0')->isNotEmpty())
                                        In Stock
                                    @else
                            ...
                            <li><span>Sizes</span> :
                                <?php $w = 1; ?>
                                <div class="btn-group-toggle nav" id="vert-tabs-tab" role="tablist"
                                    aria-orientation="horizontal">
                                    @foreach ($product->sizes->where('quantity', '>', 0) as $size)
                                        <label class="btn btn-default text-center" id="size{{ $size->id }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="review_box">
                                ...
                                <form class="row contact_form" action="{{ route('post.comment') }}" method="post"
                ...
                <div class="tab-pane fade show active" id="review" role="tabpanel" aria-labelledby="review-tab">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="review_box">
                                <h4>Add a Review</h4>
                                <form class="row contact_form" action="{{ route('post.review') }}" method="post"
                                    id="contactForm" novalidate="novalidate">
                                    @csrf
                                    <input type="hidden" name="product" value="{{ $product->name }}">
                                    <div class="col-md-12">
                            ...
                            @foreach ($related as $wish)
                                <div class="col-lg-4 col-md-4 col-sm-6 mb-20">
                                    <div class="single-related-product d-flex">
                                        ...
                                        <div class="desc">
                                            <a href="{{ route('product.view', $wish->name) }}"
                                                class="title">{{ $wish->name }}</a>
                                            <div class="price">
                                                <h6>
